...
[HttpGet("get-documentation/{id}")]
public async Task<ActionResult<IEnumerable<GetDocsDto>>> GetDocumentation(int id)
{
    try
    {
        // Retrieve the list of documentations from your repository
        var documentations = await _userRepository.GetDocsDtoByIdAsync(id); 
